...
import { Target, BookOpen, BarChart3, Award, ArrowRight, Brain, Sparkles, TrendingUp } from 'lucide-react';
                        ...
                        <div key={i} className="flex items-center gap-4">
                            <Link to={step.link}>
                                <motion.div
                                    ...
                                    whileTap={{ scale: 0.97 }}
                                    className="flex items-center gap-4 bg-white border border-gray-100 rounded-2xl px-6 py-4 shadow-sm cursor-pointer group"
                                >
